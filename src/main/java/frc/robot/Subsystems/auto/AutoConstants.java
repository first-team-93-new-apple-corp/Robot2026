...
public class AutoConstants {
    ...
    public class PresetShootingPoints {
        ...
        public static final PresetShootingPoint BlueCloseSide = new PresetShootingPoint(new Pose2d(3.525, 3.965, Rotation2d.fromDegrees(0)), ShooterMath.speedToMotorRotationsforClose(6.55).times(Constants.ShooterConstants.ShooterMotorConfigs.EfficiencyMultiplierClose), Degrees.of(90).minus(Radians.of(1.395)));
