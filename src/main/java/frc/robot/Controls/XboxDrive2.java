...
public class XboxDrive2 implements ControllerSchemeIO {
    ...
    public Trigger CombBTN(){
        return Xbox.rightStick().or(Xbox.leftStick());
    }

    public Trigger WiggleAndKick(){
        return Xbox.rightTrigger(0.5);
    }
