    ...
    public class ShooterConstants {
        ...
        public class AutoShoot {
            ...
            public static final Map<Ranges, ShootingMap> map = Map.ofEntries(
                ...
                Map.entry(Ranges.Range5pt5to6, new ShootingMap(Radians.of(1.07),ShooterMath.speedToRPM(8.6,1.8))),
                Map.entry(Ranges.Range6to6pt5, new ShootingMap(Radians.of(1.06),ShooterMath.speedToRPM(9.04,1.8))),
                Map.entry(Ranges.Range6pt5to7, new ShootingMap(Radians.of(1.05),ShooterMath.speedToRPM(9.32,1.8))),
                Map.entry(Ranges.Range7to7pt5, new ShootingMap(Radians.of(1.05),ShooterMath.speedToRPM(9.60,1.8))),
                Map.entry(Ranges.Range7pt5to8, new ShootingMap(Radians.of(1.05),ShooterMath.speedToRPM(9.60,1.8)))
